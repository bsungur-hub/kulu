<div
    ...
    <div style="background-color: #1a1a1a; padding: 25px; text-align: center; border-bottom: 4px solid #dc2626;">
        <img src="{{ $message->embed('/home/kuluwind/public_html/assets/images/logo/logo.jpg') }}" alt="Kulu Windows & Doors" style="max-width: 180px;">
    </div>

    <div style="padding: 35px 30px;">

        <h2 style="color: #1a1a1a; font-size: 22px; margin-top: 0;">{{ $isAdmin ? "Dear Admin" : "Hello " .
        $contactData['name'] }}
            , </h2>

        <p style="line-height: 1.6; font-size: 15px; color: #444;">
            {!! $isAdmin ? "You have received a new contact message from the website. Please find the details of the
            message below." : " Thank you for message! Your message has been received successfully. Our team will respond to you as soon as possible." !!}
        </p>
        ...
        <div
            ...
            <table style="width: 100%; font-size: 14px; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="padding: 10px 0; border-bottom: 1px solid #eaeaea; color: #555;">{{ $contactData['name']
                    }}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="padding: 10px 0; border-bottom: 1px solid #eaeaea; color: #555;">{{
                    $contactData['phone']}}</td>
                </tr>
                <tr>
                    <td style="padding: 10px 0; font-weight: bold; color: #222; vertical-align: top;">
                        Message:
                    </td>
                    <td style="padding: 10px 0; color: #555; line-height: 1.5;">{{ $contactData['message'] }}</td>
                </tr>
            </table>
        </div>
    ...
    @if (!$isAdmin)
        <div
            ...
            <p style="margin: 5px 0 8px 0;">
                <span style="color: #dc2626;">&#9632;</span> <strong style="color: #1a1a1a;">Kulu Windows &
                    Doors</strong>
            </p>
            <p style="margin: 4px 0; font-size: 13px;">📍 <a href="https://maps.app.goo.gl/wUmyr4rGJP3cXibBA">4911 77 Ave
                    SE,
