<div
    ...
    <div style="padding: 35px 30px;">
        ...
        <h2 style="color: #1a1a1a; font-size: 22px; margin-top: 0;">{{ $isAdmin ? "Dear Admin" : "Hello " . $quoteData['name'] }}
            , </h2>
        ...
        <div
            ...
            <table style="width: 100%; font-size: 14px; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="padding: 10px 0; border-bottom: 1px solid #eaeaea; color: #555;">{{ $quoteData['name']
                    }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 10px 0; border-bottom: 1px solid #eaeaea; color: #555;">{{ $quoteData['email']}}</td>
                </tr>
                <tr>
                    <td style="padding: 10px 0; border-bottom: 1px solid #eaeaea; font-weight: bold; color: #222;">
                        Phone:
                    </td>
                    <td style="padding: 10px 0; border-bottom: 1px solid #eaeaea; color: #555;">{{ $quoteData['phone']}}</td>
                </tr>
                <tr>
